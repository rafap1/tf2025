...
- Experiment with terraform and provider versions
- Understand the Dependency lock file `.terraform.lock.hcl`
...
- Change the code in providers.tf to:  `required_version = "~> 1.15.1"`
